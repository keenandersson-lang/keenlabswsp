-- Hotfix: prevent baseline universe from collapsing to zero when instrument_type is not normalized to 'CS'.
...
BEGIN
  ...
  SET
    ...
    metadata = jsonb_build_object(
      ...
      'rule_version', 'phase7_v2_baseline_hotfix_common_stock_gate_v1',
