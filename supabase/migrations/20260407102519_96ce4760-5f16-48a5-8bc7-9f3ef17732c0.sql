CREATE OR REPLACE FUNCTION public.materialize_wsp_indicators_from_prices(p_symbols text[] DEFAULT NULL::text[], p_as_of_date date DEFAULT ((now() AT TIME ZONE 'utc'::text))::date, p_min_bars integer DEFAULT 200)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
